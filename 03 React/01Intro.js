...
// *****************************************
// *****************************************
Until late 2016, the hardest part about working with React was just getting a new app set up with the appropriate dependencies.
Facebook recognized this problem, and released some tools to help developers get started more easily.
...
This command will only accept application names that are lower case.
If a multiple word application name is desired, separate the words with a dash. This-is-called-kabob-case.

$ yarn create react-app sample-app
This creates a directory called 'sample-app' and installs all the files and dependencies needed to get started.
Navigate into the new directory, and fire up your new app.
...
After you type yarn start you will notice your terminal is busy running React.
If you want to interact with your terminal you can open a new tab (command-t).
To stop the React app from running use the command control c
...
Navigate to App.js within the src directory.
We're going to use a class based component instead of the functional one that comes pre-built for us by React.
...
We will create a new file inside the src folder called Header.js.
It is convention to name the file the same name as the class component in that file.
// *****************************************
// *****************************************
src/Header.js
// *****************************************
